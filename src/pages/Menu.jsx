  ...
  return (
    <>
      ...
      <section className="pt-28 pb-10 px-6 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-gold/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-rose/20 rounded-full blur-3xl" />
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <ScrollReveal>
            <p className="text-gold font-body text-sm tracking-widest uppercase mb-3 font-bold">Explore</p>
            <h1 className="text-5xl sm:text-6xl font-display font-bold text-coffee mb-4">Our Menu</h1>
            <p className="text-coffee-light/70 font-body max-w-xl mx-auto">Handcrafted cakes and desserts — find your perfect match.</p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="px-6 pb-20 max-w-7xl mx-auto">
        ...
        {filtered.length === 0 && (
          <div className="text-center py-20">
            <p className="font-display text-xl text-coffee-light">No items found in this category.</p>
          </div>
        )}
      </section>
    </>
